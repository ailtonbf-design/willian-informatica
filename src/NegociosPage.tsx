...
import { Play, CheckCircle2, MessageCircle, Sparkles, ShieldCheck, Award, Users, TrendingUp, Landmark, ArrowRight } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 py-2 px-5 rounded-full text-xs sm:text-sm font-bold bg-gradient-to-r from-red-950/80 via-slate-900 to-slate-900 text-red-400 uppercase tracking-widest border border-red-500/30 shadow-lg shadow-red-950/40 backdrop-blur-md">
              ...
              <span>Escola de Vendas & Negócios</span>
            </div>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.15] tracking-tight max-w-3xl mx-auto">
              O seu negócio está crescendo ou{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-rose-500 to-amber-400 drop-shadow-sm">
                apenas sobrevivendo à competição do mercado?
              </span>
            </h1>

            {/* Subheadline */}
            <p className="text-slate-300 text-base sm:text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-normal">
              Conheça a <strong className="text-white font-bold underline decoration-brand-red decoration-2 underline-offset-4">WP Escola de Vendas e Negócios</strong>, um método prático e estruturado para empresários e profissionais liberais escalarem o faturamento com previsibilidade.
            </p>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-center gap-2 text-slate-400 text-xs sm:text-sm font-semibold tracking-wider uppercase text-center px-4">
              ...
              <span>Assista a este vídeo e descubra o método para destravar as vendas da sua empresa.</span>
            </div>
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
              Quantas oportunidades de venda sua empresa pode estar deixando passar?
            </h2>

            <p className="text-slate-300 text-base sm:text-lg leading-relaxed max-w-lg mx-auto">
              Venha até a William Informática para fazer um Diagnóstico Empresarial gratuito e conhecer 30 estratégias que podem ajudar sua empresa a vender mais e aumentar o faturamento.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 text-xs font-semibold text-slate-300 text-left">
              <div className="bg-white/5 border border-white/10 rounded-xl p-3 flex items-center gap-2">
                ...
                <span>30 estratégias de vendas</span>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-xl p-3 flex items-center gap-2">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-3 flex items-center gap-2">
                ...
                <span>Aplicação no seu negócio</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            <a 
              href="https://wa.me/5517991879478?text=Olá!%20Assisti%20ao%20vídeo%20do%20William%20e%20gostaria%20de%20agendar%20meu%20diagnóstico%20empresarial." 
              target="_blank" 
            ...
            >
              ...
              <span>QUERO AGENDAR MEU DIAGNÓSTICO GRATUITO</span>
            ...
            <div className="flex items-center justify-center gap-2 text-xs text-slate-400 font-medium">
              ...
              <span>Atendimento presencial em Bebedouro. Vagas gratuitas limitadas conforme disponibilidade.</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Consultoria Comercial Especializada</span>
            </div>
            <div className="flex items-center gap-2">
              <ShieldCheck className="w-5 h-5 text-brand-red" />
              <span>WP Escola de Vendas & Negócios</span>
            </div>
          </motion.div>
