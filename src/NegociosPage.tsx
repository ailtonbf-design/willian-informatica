        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            ...
            <div className="relative w-full max-w-[330px] aspect-[9/16] mx-auto rounded-[40px] overflow-hidden bg-slate-950 border-[7px] border-slate-800 shadow-[0_0_50px_-10px_rgba(227,0,15,0.3)] group transition-transform duration-300 hover:scale-[1.01]">
              ...
              <div 
                ...
                style={{ 
                  backgroundImage: `linear-gradient(to bottom, rgba(11, 17, 32, 0.45), rgba(11, 17, 32, 0.95)), url('https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=600&q=80')` 
                }}
              >
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
              Vendas não são obra do acaso, são processo.
            </h2>

            <p className="text-slate-300 text-base sm:text-lg leading-relaxed max-w-lg mx-auto">
              Receba gratuitamente os 7 Passos para Escalar e descubra como aplicar uma gestão comercial inteligente no seu negócio.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 text-xs font-semibold text-slate-300 text-left">
              <div className="bg-white/5 border border-white/10 rounded-xl p-3 flex items-center gap-2">
                ...
                <span>Processo de vendas previsível</span>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-xl p-3 flex items-center gap-2">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-3 flex items-center gap-2">
                ...
                <span>Aceleração de faturamento</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            <a 
              href="https://wa.me/5517991879478?text=Olá!%20Assisti%20ao%20vídeo%20do%20William%20e%20gostaria%20de%20receber%20os%207%20passos%20da%20Escola%20de%20Vendas." 
              target="_blank" 
            ...
            <div className="flex items-center justify-center gap-2 text-xs text-slate-400 font-medium">
              ...
              <span>Fale diretamente com um de nossos consultores de negócios.</span>
            </div>
          </motion.div>
